...
def inject_css():
    ...
    .kpi{background:white;border:1px solid #E3E9EF;border-radius:13px;padding:12px 14px;min-height:96px;box-shadow:0 3px 14px rgba(35,50,80,.05)}
    .kpi-label{font-size:.72rem;color:#617181;text-transform:uppercase;letter-spacing:.07em;font-weight:700}.kpi-value{font-size:1.65rem;color:#0D004C;font-weight:760;margin-top:5px}.kpi-sub{font-size:.76rem;color:#73808c}
